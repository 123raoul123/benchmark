...
#include "fft/simd_nonmerge.h"
#include "fft/nonrec_nonmerge.h"
...
/******************************************************************
*
* NEGACYCLIC FFT RECURSIVE VECTORISED NON MERGE
*
******************************************************************/
void simd_nonmerge(ring_t *r, const ring_t *x, const ring_t *y)
{
  nonmerge_forward(&vector_x,x);
  nonmerge_forward(&vector_y,y);
  ...
  nonmerge_backward(&vector_res,r);
  // print_cplx(&vector_res,CPLXDIM);
}

/******************************************************************
*
* NEGACYCLIC FFT NONRECURSIVE VECTORISED NON MERGE
*
******************************************************************/
void nonrec_nonmerge(ring_t *r, const ring_t *x, const ring_t *y)
{
  nonrec_nonmerge_forward(&vector_x,x);
  nonrec_nonmerge_forward(&vector_y,y);
  ...
  nonrec_nonmerge_backward(&vector_res,r);
  // print_cplx(&vector_res,CPLXDIM);
}
